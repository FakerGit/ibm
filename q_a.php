...
<?php
			...
			$sql="select count(*) as amount from article where module = 4 and status=3";
			...
			if($amount){
				$sql="select* from article where module = 4 and status=3 order by aid desc limit $pages,$pageSize";
...
<div id="current">
  ...
  <div id="qaTitle">
	...
	for($i=0;$i<$records;$i++){
       ...
       <div class="glist"> 
        <div class="gimg">
         <a href="articlebrowse.php?aid=<?php echo $rowset[$record]['aid']; ?>" target="_blank"><img src="<?php echo $rowset[$record]['pic']; ?> " height="93" width="145" /></a>
        </div> 
        <div class="gtitle"> 
         <p class="strong"><a href="articlebrowse.php?aid=<?php echo $rowset[$record]['aid']; ?>" target="_blank"><?php echo $rowset[$record]['title']; ?></a></p> 
