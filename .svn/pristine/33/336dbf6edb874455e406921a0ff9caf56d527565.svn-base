...
<div class="m-form">
    <form name="frm" action="registercheck.php" method="get">
        <fieldset>
            ...
            <div class="formitm">
                <label class="lab">再次输入密码：</label>
                <div class="ipt">
                    <input type="password" class="u-ipt" name="repwd" id="repwd" onBlur="repwdcommit();"/>
                </div>
            </div>
            <div class="formitm formitm-1"><button class="u-btn" type="submit" name="submit" id="submit">注册</button>&nbsp;&nbsp;&nbsp;&nbsp;
